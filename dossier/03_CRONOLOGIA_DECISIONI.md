...
## 04/09/2026 — Un solo scambio server-authoritative per Sostituzione e Narratore 4.8
Antonello autorizza il candidato offline P1-A/P1-B/P1-C: il resolver comune della Sostituzione resta unica autorità e il ramo legacy dell'Esame dovrà essere sostituito integralmente, non affiancato. Adapter e ricevuta POV condividono una sola identità di scambio; contrattacco e iniziativa restano fatti server-side, mentre Luna riceve soltanto una proiezione semantica viewer-safe. La decisione non autorizza apply, enable, deploy o smoke; prima servono branch QA Healthy/allineato, campagna integrata e review indipendente 0/0/0.
