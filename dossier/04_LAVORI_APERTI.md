...
|---|---|---|---|
| `management/candidati/CLAN-L1_2026-09-01/` | Raccordo20260909154236 e smokeClone/Fato PASS; seguito16:13Passa/Fato PASS,12superfici integre. | MovimentoPG autonomo non offerto e presa assente; raccordo da preparare, poi mosseSabaku residue eFlussi. Uchiha integrazione/qualifica aperte. | PM, DB/COMBAT, LAND/RULES |
...
| `management/candidati/NARRATORE-UNIFICATO_2026-09-02/` | Ripresa architettura nella taskPM; verificato09/09 che il percorsoStaff non trasmette description/effetti. Vecchi cicli terminali preservati. | Contratto reviewato0/0/0; implementare raccordo ordinary con fonti esistenti e lifecycle server, poi multi-attore con mappe/luoghi, PNG, quest e missioni durante l’espansione. | NARRATIVE-AI, DB, QA, PM |
