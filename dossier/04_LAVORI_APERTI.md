...
| `management/candidati/NARRATORE-UNIFICATO_2026-09-02/` | Ripresa architettura nella taskPM; verificato09/09 che il percorsoStaff non trasmette description/effetti. Vecchi cicli terminali preservati. | Contratto documentale0/0/0; primo raccordo tecnico terminaleROSSO0/8, compilazioneSQL da correggere in seguito autorizzato. Dopo ordinary: multi-attore, mappe/PNG, quest/missioni. | NARRATIVE-AI, DB, QA, PM |
