...
Riscritta il 04/09/2026 · da Codex (`EXAM-REC-OPEN-001`) · **stato dell'area: 13 asset sito allineati; nessun file `sito_live/`, SQL o Edge modificato; documenti del fix REC e QA archiviato caricati e verificati su `main`** (`sito_live/` contiene anche `AGENTS.md`, file locale di governo non contato nella tabella)
