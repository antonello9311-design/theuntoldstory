...
**La seconda natura è un elemento a tutti gli effetti.** Chi la ottiene — **300 XP, dal rango Jonin** (§8.6) — possiede **due** elementi, non uno con un'appendice: valgono entrambi ovunque serva un elemento, per il vantaggio elementale in combattimento come per i requisiti delle tecniche. La scheda li mostra tutti e due.
