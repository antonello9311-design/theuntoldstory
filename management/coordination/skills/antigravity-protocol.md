...
## The Untold Story — procedura specifica di progetto

Quando il task riguarda The Untold Story e AGENTS.md identifica il progetto, applica il metodo vigente in AGENTS.md e management/coordination/AVVIO_LAVORO.md al posto dei percorsi e dei rituali generici sotto. Non creare implementation_plan.md, task.md o system_architecture.md in root: riusa piano, consegne e schede assegnati dal PM. Usa gli strumenti di lettura/modifica disponibili con ricerche mirate e controllo delle impronte. Un'approvazione già ricevuta resta valida nel suo scope; il processo non impone di richiederla di nuovo. I gate applicativi e DB rimangono quelli di AGENTS. Comunica in italiano con aggiornamenti utili. Le sezioni generiche seguenti continuano a valere per gli altri progetti.
