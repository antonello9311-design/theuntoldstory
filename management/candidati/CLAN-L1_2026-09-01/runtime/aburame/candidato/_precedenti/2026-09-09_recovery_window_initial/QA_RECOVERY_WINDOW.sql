...
BEGIN
 BEGIN
PERFORM pg_temp.v2(1,'2026-01-01 02:00+00',NULL,true);PERFORM pg_temp.v2(2,'2026-01-01 03:00+00','2026-01-01 08:00+00',true);a:=pg_temp.window();ASSERT a->>'eligible'='true' AND (a->>'combat_seconds')::numeric=0 AND (a->>'rest_seconds')::numeric=86400;
 RAISE EXCEPTION 'qa_case_rollback' USING ERRCODE='ZQ001';
