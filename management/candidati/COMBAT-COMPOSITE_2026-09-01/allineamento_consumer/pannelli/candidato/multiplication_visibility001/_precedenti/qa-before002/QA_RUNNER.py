...
DB='combat_multiplication_visibility_001'
...
IF EXISTS(SELECT 1 FROM pg_database WHERE datname='combat_multiplication_visibility_001') THEN RAISE EXCEPTION 'qa_database_already_exists_no_reuse';END IF;
...
END $guard$;
SELECT 'CREATE DATABASE combat_multiplication_visibility_001 OWNER postgres TEMPLATE template0'\n\\gexec
"""
SESSION="""BEGIN;
