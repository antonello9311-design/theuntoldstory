...
begin
 ...
 then raise exception 'MR_DEFAULT_MAP_SCOPE_RECOVERY_DRIFT' using errcode='40001';end if;
 ...
 then raise exception 'MR_DEFAULT_MAP_SCOPE_RECOVERY_MISMATCH' using errcode='40001';end if;
end
$recovery$;
