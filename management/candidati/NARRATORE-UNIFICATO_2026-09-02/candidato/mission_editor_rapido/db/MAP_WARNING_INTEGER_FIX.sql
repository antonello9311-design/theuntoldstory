...
begin
 ...
 if current_md5='c988923b347cc600b85bb215ea025663' then return;end if;
 if current_md5<>'f53d1a36873ee8a82c8c8d149e96fe79'
  or (length(current_definition)-length(replace(current_definition,old_fragment,'')))/length(old_fragment)<>1
 then raise exception 'MR_MAP_WARNING_INTEGER_BASELINE_DRIFT' using errcode='40001';end if;
 ...
 if result_md5<>'c988923b347cc600b85bb215ea025663'
 then raise exception 'MR_MAP_WARNING_INTEGER_INSTALL_MISMATCH' using errcode='40001';end if;
end
$apply$;
