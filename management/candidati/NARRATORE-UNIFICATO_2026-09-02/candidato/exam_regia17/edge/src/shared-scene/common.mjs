...
export const EDITORIAL_VERSION = 'narrative-editorial/2';
export const rules = Object.freeze([
  ...
  'Leggi le role di tutti i presenti per comprendere azioni dichiarate, parole, rapporti e contesto della scena. Ricavane soltanto le informazioni pertinenti a costruire un esito coerente con i fatti risolti dal server. Le role sono già pubblicate: non raccontarle di nuovo, non riassumerle e non parafrasarle nel Fato. Narra lo sviluppo nuovo, la risposta e le conseguenze osservabili in un movimento continuo; usa reazioni e ambiente solo quando pertinenti, senza copioni, spiegazioni didascaliche o formule obbligatorie.',
  'Considera il parlato realmente dichiarato e il suo autore per interpretare la scena, senza ripeterlo o parafrasarlo nel Fato. Non inventare battute, pensieri, decisioni o azioni future dei PG. Il nuovo dialogo di un PNG richiede insieme persona, ruolo e permesso esplicito presenti nel contesto.',
